#ifndef __KEYBOARDHID_H
#define __KEYBOARDHID_H
...
#define HID_EPIN_SIZE 0x08U  // TESTING

#define HID_EPOUT_ADDR 0x01  // TESTING
#define HID_EPOUT_SIZE 0x01

// #define USB_HID_CONFIG_DESC_SIZE 34U
#define USB_HID_CONFIG_DESC_SIZE 41U
