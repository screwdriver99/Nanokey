...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOA, STCP_Pin|SHCP_Pin|BATLOW_Pin|WUP_BTMOD_Pin
                          |CAPS_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : STCP_Pin SHCP_Pin BATLOW_Pin WUP_BTMOD_Pin
                           CAPS_Pin */
  GPIO_InitStruct.Pin = STCP_Pin|SHCP_Pin|BATLOW_Pin|WUP_BTMOD_Pin
                          |CAPS_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
